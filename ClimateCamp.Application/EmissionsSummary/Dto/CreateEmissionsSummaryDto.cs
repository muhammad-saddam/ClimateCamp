...
{
    [AutoMapTo(typeof(Core.EmissionsSummary))]
    public class CreateEmissionsSummaryDto : EntityDto<Guid>
    {
        ...
        [NotMapped]
        public List<CreateEmissionsSummaryScopeDetailsDto> EmissionsSummaryScopeDetails { get; set; }
