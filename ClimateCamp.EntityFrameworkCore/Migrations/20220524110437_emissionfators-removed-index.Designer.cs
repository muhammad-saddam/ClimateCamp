...
namespace ClimateCamp.Migrations
{
    ...
    [Migration("20220524110437_emissionfators-removed-index")]
    partial class emissionfatorsremovedindex
    {
            ...
            modelBuilder.Entity("ClimateCamp.CarbonCompute.EmissionsFactor", b =>
                {
                    ...
                    b.Property<int?>("EmissionsSourceId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmissionsSourceId1")
                        .IsUnique()
                        .HasFilter("[EmissionsSourceId1] IS NOT NULL");
            ...
            modelBuilder.Entity("ClimateCamp.CarbonCompute.EmissionsFactor", b =>
                {
                    ...
                    b.HasOne("ClimateCamp.CarbonCompute.EmissionsSource", null)
                        .WithOne("EmissionsFactors")
                        .HasForeignKey("ClimateCamp.CarbonCompute.EmissionsFactor", "EmissionsSourceId1");
