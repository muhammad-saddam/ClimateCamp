...
namespace ClimateCamp.Migrations
{
    ...
    [Migration("20211222203558_AddedTblCountry_ChangedCountryColumnType")]
    partial class AddedTblCountry_ChangedCountryColumnType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClimateCamp.Organization.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClimateCamp.Organization.OrganizationUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClimateCamp.CarbonCompute.ActivityData", b =>
                {
                    ...
                    b.HasOne("ClimateCamp.Organization.OrganizationUnit", "OrganizationUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("ClimateCamp.Organization.OrganizationUnit", b =>
                {
                    b.HasOne("ClimateCamp.Organization.Organization", "Organization")
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClimateCamp.Organization.OrganizationUnit", "ParentOrganizationUnit")
                        .WithMany("Children")
