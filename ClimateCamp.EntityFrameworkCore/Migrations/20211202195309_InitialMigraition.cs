...
namespace ClimateCamp.Migrations
{
    public partial class InitialMigraition : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EmissionsFactorsLibraries",
                schema: "Reference",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmissionsFactorsLibraries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmissionScope = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmissionsSources", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GWPFactor = table.Column<float>(type: "real", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GreenhouseGases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustrialProcesses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingPreferenceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PictureName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PicturePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnnualReportingPeriod = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityTypes_EmissionsSources_EmissionsSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VATNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthlyRevenue = table.Column<double>(type: "float", nullable: false),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DataQualityType = table.Column<int>(type: "int", nullable: false),
                    ConsumptionStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ConsumptionEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Quantity = table.Column<float>(type: "real", nullable: false),
                    UnitId = table.Column<int>(type: "int", nullable: false),
                    IndustrialProcessId = table.Column<int>(type: "int", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityData_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActivityData_AbpUsers_DeleterUserId",
                        column: x => x.DeleterUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActivityData_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityData_OrganizationUnits_OrganizationUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmissionsFactorsLibraryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ResponsibleEntityID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ResponsibleEntityType = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CO2 = table.Column<float>(type: "real", nullable: false),
                    CO2UnitId = table.Column<int>(type: "int", nullable: true),
                    CH4 = table.Column<float>(type: "real", nullable: false),
                    CH4UnitId = table.Column<int>(type: "int", nullable: true),
                    N20 = table.Column<float>(type: "real", nullable: false),
                    N20UnitId = table.Column<int>(type: "int", nullable: true),
                    HFCs = table.Column<float>(type: "real", nullable: false),
                    HFCsUnitId = table.Column<int>(type: "int", nullable: true),
                    NF3 = table.Column<float>(type: "real", nullable: false),
                    NF3UnitId = table.Column<int>(type: "int", nullable: true),
                    PFCs = table.Column<float>(type: "real", nullable: false),
                    PFCsUnitId = table.Column<int>(type: "int", nullable: true),
                    SF6 = table.Column<float>(type: "real", nullable: false),
                    SF6UnitId = table.Column<int>(type: "int", nullable: true),
                    CO2E = table.Column<float>(type: "real", nullable: false),
                    CO2EUnitId = table.Column<int>(type: "int", nullable: true),
                    OtherGHGs = table.Column<float>(type: "real", nullable: false),
                    OtherGHGsUnitId = table.Column<int>(type: "int", nullable: true),
                    TotalCO2E = table.Column<float>(type: "real", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_EmissionsFactorsLibraries_EmissionsFactorsLibraryId",
                        column: x => x.EmissionsFactorsLibraryId,
                        principalSchema: "Reference",
                        principalTable: "EmissionsFactorsLibraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Emissions_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_CH4UnitId",
                        column: x => x.CH4UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        column: x => x.CO2EUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_CO2UnitId",
                        column: x => x.CO2UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_HFCsUnitId",
                        column: x => x.HFCsUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_N20UnitId",
                        column: x => x.N20UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_NF3UnitId",
                        column: x => x.NF3UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_OtherGHGsUnitId",
                        column: x => x.OtherGHGsUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_PFCsUnitId",
                        column: x => x.PFCsUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emissions_Units_SF6UnitId",
                        column: x => x.SF6UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmissionsSourceId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CO2 = table.Column<float>(type: "real", nullable: false),
                    CO2UnitId = table.Column<int>(type: "int", nullable: true),
                    ...
                    OtherGHGsUnitId = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DocumentationReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganizationUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmissionsFactors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_EmissionsFactorsLibraries_LibraryId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_CH4UnitId",
                        column: x => x.CH4UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_CO2EUnitId",
                        column: x => x.CO2EUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_CO2UnitId",
                        column: x => x.CO2UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_HFCsUnitId",
                        column: x => x.HFCsUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_N20UnitId",
                        column: x => x.N20UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_NF3UnitId",
                        column: x => x.NF3UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_OtherGHGsUnitId",
                        column: x => x.OtherGHGsUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_PFCsUnitId",
                        column: x => x.PFCsUnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmissionsFactors_Units_SF6UnitId",
                        column: x => x.SF6UnitId,
                        principalSchema: "Reference",
                        principalTable: "Units",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_ActivityTypeId",
                schema: "Transactions",
                table: "ActivityData",
                column: "ActivityTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_CreatorUserId",
                schema: "Transactions",
                table: "ActivityData",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_DeleterUserId",
                schema: "Transactions",
                table: "ActivityData",
                column: "DeleterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_LastModifierUserId",
                schema: "Transactions",
                table: "ActivityData",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_OrganizationUnitId",
                schema: "Transactions",
                table: "ActivityData",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_UnitId",
                schema: "Transactions",
                table: "ActivityData",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityTypes_EmissionsSourceId",
                schema: "Reference",
                table: "ActivityTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emissions_CH4UnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "CH4UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_CO2EUnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "CO2EUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_CO2UnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "CO2UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_EmissionsFactorsLibraryId",
                schema: "Transactions",
                table: "Emissions",
                column: "EmissionsFactorsLibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_HFCsUnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "HFCsUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_N20UnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "N20UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_NF3UnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "NF3UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_OrganizationUnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_OtherGHGsUnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "OtherGHGsUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_PFCsUnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "PFCsUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Emissions_SF6UnitId",
                schema: "Transactions",
                table: "Emissions",
                column: "SF6UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_CH4UnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "CH4UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_CO2EUnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "CO2EUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_CO2UnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "CO2UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_HFCsUnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "HFCsUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_LibraryId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "LibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_N20UnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "N20UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_NF3UnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "NF3UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_OrganizationUnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_OtherGHGsUnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "OtherGHGsUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_PFCsUnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "PFCsUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_EmissionsFactors_SF6UnitId",
                schema: "Reference",
                table: "EmissionsFactors",
                column: "SF6UnitId");
