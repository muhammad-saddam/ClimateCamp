...
namespace ClimateCamp.PowerBI
{
    ...
    /// Power Bi Client
    /// </summary>
    public class PowerBIManager : IPowerBIManager, ITransientDependency
    {
        private readonly IPowerBIAuthentication _provider;
        private readonly string urlPowerBiServiceApiRoot = "https://api.powerbi.com";
        /// <summary>
        /// Initialize Power Bi Service
        /// </summary>
        public PowerBIManager(IPowerBIAuthentication provider)
        {
            _provider = provider;
        }
        ...
        {
            var tokenCredentials = new TokenCredentials(_provider.GetTokenAsync(), "Bearer");
        ...
        /// Get Power Bi Client
        /// </summary>
        public string GetPowerBIAuthToken()
        {
            return _provider.GetTokenAsync();
        }

        //use these guid for group and workspace if Guid
        // reportId = Guid.Parse("87808bbc-3611-4e5e-bd9f-3eea20a81cb7");
        ...
        public EmbedParams GetEmbedParams(Guid reportId, Guid workspaceId)
        {
            try
            {
                ...
                // Refresh dataset
                // pbiClient.Datasets.RefreshDataset(workspaceId, pbiReport.DatasetId);
                var datasets = pbiClient.Datasets.GetDatasets(workspaceId);
